 ...
 * 
 * This is the main layout wrapper for all authenticated admin pages.
 ...
 * 
 * USAGE:
 * Wrap any admin page content with this layout component:
 * 
 * <AdminLayout>
 *   <YourPageContent />
 * </AdminLayout>
  ...
  return (
    <div className="admin-layout">
      ...
      */}
      <main className={`admin-content ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        ...
        */}
        <div className="mobile-header">
          ...
          <h1 className="mobile-title">NPC Admin Panel</h1>
        </div>
        ...
        {/* 
          ...
          - Examples: Dashboard, Reports, Classes, etc.
        */}
      ...
      {/* 
        FLOATING CLOCK
        - Same clock component used across the app
