...
const ViewWeekReportsPage = () => {
  ...
  // Mock data for reports in this week
  const weekReports: Report[] = [
    ...
    {
      id: 4,
      title: 'Weekly Safety Check - Physics Lab',
  ...
  const stats = {
    ...
    pending: weekReports.filter(r => r.status === 'pending').length,
  ...
  const getItemStats = (items: Report['items']) => {
    return {
      ...
      <div className="page-header" style={{ marginBottom: '2rem' }}>
        <div>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#1a202c', margin: '0.5rem 0 0 0' }}>
            Week {weekNumber} Reports
          </h1>
          <p style={{ color: '#718096', marginTop: '0.5rem', fontSize: '0.95rem' }}>
            All reports submitted during this week
          </p>
        </div>
      </div>
        ...
        <div className="modal-overlay" onClick={handleCloseModal}>
          <div className="modal-content report-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <h3 className="items-title">Inspection Items</h3>
